        ...
        <div className='container my-5'>
            <div className="row py-4">
                ...
                <form className='col-md-6 mb-3'>
                    ...
                    />
                    <Link to="/products/sellers" type="button" className="btn btn-outline-dark py-2 my-3">Discard
                        Changes</Link>
                    <button type="submit" id='liveAlertBtn' className="btn btn-outline-dark py-2 my-3 ms-2"
                            onClick={submitHandler}>Save Changes
                    </button>
                </form>
            </div>
        </div>
